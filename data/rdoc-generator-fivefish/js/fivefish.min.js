...
function onReady() {
    console.debug("Ready!"), $("header.hero-unit h1").popover({
        placement: "right"
    ...
    }), $.getJSON("search_index.json").success(function(a) {
        console.debug("Setting up search."), searchIndex = a;
        var b = $(a).map(function(a, b) {
            return console.debug("Mapping %s.", b.name), b.name;
        });
        $("input.search-query").typeahead({
            source: b,
            matcher: function(a) {
                var b = new RegExp(this.query, "i");
                return console.debug("Matching %s", a), b.test(a);
            }
        });
    });
}
...
var searchIndex = [], keyboardShortcuts = {
    "/": function(a) {
